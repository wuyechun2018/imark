										...
										<td>
											<div class="form-control">
												<span class="r"></span> <span class="l"></span> <span
													...
													onFocus="var d5222=$dp.$('endDate');WdatePicker({onpicked:function(){},maxDate:'#F{$dp.$D(\'endDate\')}', readOnly:true})" />
									...
									<tr>
										<td colspan="4" class="text-right"><a
											class="btn btn-primary" id="queryBtn" href="javascript:;">
												<span class="l"></span> <span class="c"  style="color:#333" id="search"><i
