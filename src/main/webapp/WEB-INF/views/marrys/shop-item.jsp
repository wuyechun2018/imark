...
<head>
  ...
  <link href="${ctx}/resources/metronic-3.1.3/assets/global/plugins/uniform/css/uniform.default.css" rel="stylesheet" type="text/css">
  <link href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" rel="stylesheet" type="text/css"><!-- for slider-range -->
  <link href="${ctx}/resources/metronic-3.1.3/assets/global/plugins/rateit/src/rateit.css" rel="stylesheet" type="text/css">
          ...
          <div class="top-cart-content-wrapper">
            <div class="top-cart-content">
              <ul class="scroller" style="height: 250px;">
                <li>
                  <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/cart-img.jpg" alt="Rolex Classic Watch" width="37" height="34"></a>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      ...
                      <div class="col-md-12 nav-brands">
                        <ul>
                          <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/brands/esprit.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/brands/gap.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="next" alt="next" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/brands/next.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/brands/puma.jpg"></a></li>
                          <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/brands/zara.jpg"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="#" class="btn btn-default add2cart">Add to cart</a>
                      ...
                      <div class="col-md-3 col-sm-4 col-xs-6">
                        <div class="product-item">
                          <div class="pi-img-wrapper">
                            <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                          </div>
                          <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                          <div class="pi-price">$29.00</div>
                          <a href="#" class="btn btn-default add2cart">Add to cart</a>
        ...
        <div class="row margin-bottom-40">
          ...
          <div class="sidebar col-md-3 col-sm-5">
            ...
            <div class="sidebar-products clearfix">
              <h2>Bestsellers</h2>
              <div class="item">
                <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/k1.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
                <div class="price">$31.00</div>
              </div>
              <div class="item">
                <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/k4.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
                <div class="price">$23.00</div>
              </div>
              <div class="item">
                <a href="shop-item.html"><img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/k3.jpg" alt="Some Shoes in Animal with Cut Out"></a>
                <h3><a href="shop-item.html">Some Shoes in Animal with Cut Out</a></h3>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6">
                  <div class="product-main-image">
                    <img src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model7.jpg" alt="Cool green dress with red bell" class="img-responsive" data-BigImgsrc="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model7.jpg">
                  </div>
                  <div class="product-other-images">
                    <a href="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model3.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model3.jpg"></a>
                    <a href="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model4.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model4.jpg"></a>
                    <a href="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model5.jpg" class="fancybox-button" rel="photos-lib"><img alt="Berry Lace Dress" src="${ctx}/resources/metronic-3.1.3/assets/frontend/pages/img/products/model5.jpg"></a>
                  </div>
                </div>
                <div class="col-md-6 col-sm-6">
...
Nostrud duis molestie at dolore.</p>
    ...
    <script src="${ctx}/resources/metronic-3.1.3/assets/global/plugins/uniform/jquery.uniform.min.js" type="text/javascript"></script>
    <script src="${ctx}/resources/metronic-3.1.3/assets/global/plugins/rateit/src/jquery.rateit.js" type="text/javascript"></script>
