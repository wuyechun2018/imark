...
function display(obj,articleType){
    ...
    success:function(data, textStatus) {
			...
			contentHTML+=				'<a href="${ctx}/html/showContent?articleId='+data[i].ARTICLE_ID+'" target="_blank">'
			...
			contentHTML+=				'<h1><a href="${ctx}/html/showContent?articleId='+data[i].ARTICLE_ID+'" target="_blank">'+data[i].ARTICLE_TITLE+'</a></h1>'
