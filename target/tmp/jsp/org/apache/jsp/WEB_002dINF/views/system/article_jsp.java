...
public final class article_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\r\n");
      out.write("function showArticle(id){\r\n");
      out.write("\tlocation.href=ctx+\"/editor/showArticle?articleId=\"+id;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tcolumns:[[\r\n");
      out.write("\t\t          {field:'ARTICLE_ID',title: 'ARTICLE_ID',align: 'center',width: 100,hidden:true},\r\n");
      out.write("\t\t          {field:'ARTICLE_TITLE',title: '文章标题',align: 'center',width: 100,formatter:function(value,row,index){\r\n");
      out.write("\t\t          \t\t //return \"<span ><a onclick=showArticle('\"+row.ARTICLE_ID+\"') href='javascript:void(0)'\"+value+\"</a></span>\";\r\n");
      out.write("\t\t          \t\t return \"<a onclick=showArticle('\"+row.ARTICLE_ID+\"') href='javascript:void(0)'>\"+value+\"</a>\";\r\n");
      out.write("\t\t           }\r\n");
      out.write("\t\t          }, \r\n");
      out.write("\t\t          {field:'ARTICLE_TYPE',title: '文章类型',align: 'center',width: 100}, \r\n");
      out.write("\t\t          {field:'ARTICLE_DESC',title: '简介',align: 'center',width: 100}, \r\n");
      out.write("\t\t          {field:'KEY_WORD',title: '关键字',align: 'center',width: 100}, \r\n");
      out.write("\t\t          {field:'UPDATE_USER_ID',title: '更新人',align: 'center',width: 100}, \r\n");
      out.write("\t\t          {field:'UPDATE_DATE',title: '更新时间',align: 'center',width: 100}\r\n");
      out.write("\t\t]],\r\n");
      out.write("\t\ttoolbar:[{\r\n");
      out.write("\t\t\t\t\t\ttext : '增加',\r\n");
      out.write("\t\t\t\t\t\ticonCls : 'icon-add',\r\n");
      out.write("\t\t\t\t\t\thandler : function() {\r\n");
      out.write("\t\t\t\t\t\t\tlocation.href=ctx+\"/views/system/ckeditor\";\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}, '-',{\r\n");
      out.write("\t\t\t\t\t\ttext : '删除',\r\n");
      ...
      out.write("                    <label for=\"txtSystemType_ID\">文章类型：</label>\r\n");
      out.write("                    <input class=\"easyui-combobox\" type=\"text\" ID=\"articleType\" name=\"articleType\" style=\"width:150px\"  />&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("                    <label for=\"txtLoginName\">关键字：</label>\r\n");
      out.write("                    <input type=\"text\" ID=\"keyword\" name=\"keyword\" style=\"width:150px\"  />&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("                   \r\n");
      out.write("                </div>\r\n");
      out.write("\t\t        <div>\r\n");
      out.write("                    <label for=\"txtLastUpdated\">开始时间：</label>\r\n");
      out.write("                    <input class=\"easyui-datebox\" type=\"text\" ID=\"updateDate_start\" name=\"updateDate_start\" style=\"width:150px\"  />&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
      out.write("                    <label for=\"txtLastUpdated2\">结束时间：</label>\r\n");
      out.write("                    <input class=\"easyui-datebox\" type=\"text\" ID=\"updateDate_end\" name=\"updateDate_end\" style=\"width:150px\"  />&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\r\n");
